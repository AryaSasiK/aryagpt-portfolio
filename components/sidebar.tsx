...
export default function Sidebar({ isOpen, onNewChat, chats = [], onChatSelected, onClose }: SidebarProps) {
    ...
    <>
      ...
      {isMobile && isOpen && (
        <div
          ...
          onClick={() => onClose ? onClose() : null} // Close sidebar when overlay is clicked
        />
      )}
      
      <div
        className={`fixed top-0 left-0 w-64 h-full bg-[#171717] flex flex-col overflow-hidden transition-all ${isOpen ? "translate-x-0" : "-translate-x-full"} z-40`}
        style={{
