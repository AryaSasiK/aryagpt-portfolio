    ...
    <div className="flex flex-col h-[calc(100dvh-56px)] overflow-hidden" key={renderKey}>
      ...
      <div className="flex-1 overflow-y-auto bg-[#212121] pb-16 sm:pb-24">
        {initialMessages.length === 0 ? (
          <div className="absolute sm:relative inset-0 sm:inset-auto flex flex-col items-center justify-center h-full max-w-2xl mx-auto px-3 pt-0 pb-2 sm:px-4 sm:py-8">
